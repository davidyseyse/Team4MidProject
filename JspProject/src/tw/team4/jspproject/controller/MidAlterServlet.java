...
/**
 * Servlet implementation class MidAlterServlet
 */
@WebServlet("/MidAlterServlet.do")
public class MidAlterServlet extends HttpServlet {
	...
	private void processAction(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		RequestDispatcher dis = request.getRequestDispatcher("jsp/team4/product/AlterProduct.jsp");
