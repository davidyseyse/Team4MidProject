...
@WebServlet("/jsp/team4/company/companyInf")
public class companyInfServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//寫判斷getparameter()拿到form裡的資料
		//做判斷轉型 塞javabean呼叫Dao
...
//		String busRC = request.getParameter("busRC");
		...
		CompanyJavabean compJB = new CompanyJavabean(companyName,uniformNumbers,categories,
		...
		//做DAO 連線
		boolean result = compDao.addcomp(compJB);
...
//			sendredirect company.jsp
			...
			out.write("Insert Profiles Fail.<br/>");
		}
