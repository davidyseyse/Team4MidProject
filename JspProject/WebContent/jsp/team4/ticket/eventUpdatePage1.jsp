...
<form name="myForm" action="EventUpdateSystemProcessServlet1.do" method="post">
	...
	<script>
		$("#sailingSys").val('${event.organizationId}');
	</script>	
		<label class="t1" for="" id="sailingSys">售票系統:</label>
		...
		<label class="t1" for="" >起始售票時間:</label>
			<input type="date" name="onSaleD" required="required" value="${exhibition.onSaleDate}">
			<input type="time" name="onSaleT" required="required" value="${exhibition.onSaleDate}"><br><br>
		<label class="t1" for="">結束售票時間:</label>
			<input type="date" name="offSaleD" required="required" value="${exhibition.offSaleDate}">
			<input type="time" name="offSaleT" required="required" value="${exhibition.offSaleDate}"><br><br>
		<label class="t1" for="">展覽起始日:</label>
			<input type="date" name="commDate" required="required" value="${exhibition.commDate}"><br><br>
		<label class="t1" for="">展覽終止日:</label>
			<input type="date" name="dueDate" value="${exhibition.dueDate}"><br><br>
		<label class="t1" for="">描述:</label>
			<textarea style="resize:none;width:600px;height:200px;" name="description" >${exhibition.description}</textarea><br><br>
		
	
		<label class="t1" for="" id="ccard" >優惠信用卡:</label>	
...
<script>
$("#cardId option[value='${exhibition.cardId}']").attr('selected', 'selected');
	</script>				
		<!-- 
