...
<c:forEach var="eb" items="${eventbean}">
<tr>
<td>${eb.eventId}</td>
<td>${eb.typeId}</td>
<td>${eb.eventName}</td>
<td>${eb.eventLocation}</td>
<td>${eb.organizationId}</td>
<td>
<form action="detailEventServlet.do" method="post">
	<input type="hidden" name="typeId" value="${eb.typeId}"/>
	<input type="hidden" name="companyId" value="1"/>
	<input type="hidden" name="eventId" value="${eb.eventId}"/>
...
<a href="eventInputPage1.jsp" class="btn btn-success" role="button">新增票券</a>
</body>
</html>